...
// 确定切换地址
const confirm = () => {
  userAddress.value = activeAddress.value;
    ...
    <div class="container">
      <div class="wrapper">
        ...
        <div class="box-body">
          <div class="address">
            <div class="text">
              <div class="none" v-if="!userAddress">
                您需要先添加收货地址才可提交订单。
              </div>
              <ul v-else>
                <li>
                ...
                <li>
                  <span>收货地址：</span>{{ userAddress.fullLocation }}
                  {{ userAddress.address }}
                </li>
              </ul>
            </div>
        ...
        <!-- 提交订单 -->
        <div class="submit">
          <el-button @click="handleCreateOrder" type="primary" size="large"
            >提交订单</el-button
          >
        </div>
      </div>
